...
def create_ui(send_transactions_callback, stop_transactions_callback, toggle_key_visibility_callback, start_thread_callback):
    ...
    networks = ['Ethereum', 'BSC', 'Polygon', 'Avalanche C', 'Ethereum PoW', 'Moonbeam', 'Evmos', 'Fantom', 'Dogechain', "OKC (OKX Chain)", "PalseChain Testnet V3", 'X1 Devnet']  # Add more networks here if needed
...
def update_inputs(*args):
    ...
    if selected_network == 'Ethereum':
        ...
        contract_address_entry.delete(0, END)
        contract_address_entry.insert(0, '0x0987654321')
        chain_id_entry.delete(0, END)
        ...
        'Ethereum', 'BSC', 'Polygon', 'Avalanche C', 'Ethereum PoW', 'Moonbeam', 'Evmos', 'Fantom', 'Dogechain', "OKC (OKX Chain)", "PalseChain Testnet V3", 'X1 Devnet'  
